...
namespace SimpleMVC.Controllers
{
    public class Profilev1 : Controller
    {
        ...
        public ActionResult Index()
        {
            ...
            {
                new Income() {Id = 1, Date = DateTime.Now, Wyplata = 3500, DodatkowaPraca = 500, Renta = 0},
                new Income() {Id = 2, Date = DateTime.UtcNow,  Wyplata = 10000, DodatkowaPraca = 5000, Renta = 0},
                new Income() {Id = 3, Date = DateTime.Now, Wyplata = 0, DodatkowaPraca = 0, Renta = 2500},
                new Income() {Id = 4, Date = DateTime.UtcNow, Wyplata = 6500, DodatkowaPraca = 600, Renta = 0},
                new Income() {Id = 5, Date = DateTime.Now, Wyplata = 5500, DodatkowaPraca = 700, Renta = 0}
            };
